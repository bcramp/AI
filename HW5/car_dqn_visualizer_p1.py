...
GAMMA = 0.9           # Discount Factor; changed from 0.99 to 0.9 for part 1
        ...
        if not done:
            ...
            if done:
                ...
                if success_count >= SUCCESS_THRESHOLD and not is_trained:
                    ...
                    if current_steps == 0:
                        # Prints the episode count and average reward during the episode
                        print(f"{episode_count},{total_reward}")
                    else:
                        # Prints the episode count and average reward during the episode
                        print(f"{episode_count},{total_reward / current_steps}")
